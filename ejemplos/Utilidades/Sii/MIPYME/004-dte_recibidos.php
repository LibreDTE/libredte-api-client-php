 ...
 *  - Obtener listado de DTE recibidos en el Portal MIPYME del SII
...
$recibidos = $LibreDTE->post('/utilidades/sii/mipyme_dte_recibidos/'.$contribuyente, [
    'auth'=>[
        'rut' => $rut,
        'clave' => $contrasenia,
    ],
...
if ($recibidos['status']['code']!=200) {
    die('Error al obtener DTE recibidos en Portal MIPYME del SII: '.$recibidos['body']."\n");
}
